...
<head>
    <link rel="stylesheet" href="NotificacionesStyle.css">
...
<body>
    ...
    <nav class="navbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="../Préstamos/PrestamosHTML.php" class="nav-link">
                    ...
                    <span class="link-text">Préstamos</span>
                </a>
            </li>
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th></th>
                            <th></th>
                            <th>Historial de Movimientos</th>
                            <th></th>
                            <th></th>
                            <th></th>
    ...
    <nav class="navbar-bottom">
        ...
        <button type="button" class="bottom-itemadd" onclick="window.location.href = 'FormUsers.php';">
        ...
        <button type="button" class="bottom-itemdel">
            <span class="bottom-item__text">Borrar</span>
            <span class="bottom-item-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <button type="button" class="bottom-itemmod">
            <span class="bottom-item__text">Modificar</span>
            <span class="bottom-item-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <button type="button" class="bottom-itempass">
            <span class="bottom-item__text"> Cambiar Password</span>
            <span class="bottom-item-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <button type="button" class="bottom-itempriv">
            <span class="bottom-item__text"> Privilegio </span>
            <span class="bottom-item-icon">
    ...
    -->
    <script src="NotificacionesJS.js"></script>
</body>
