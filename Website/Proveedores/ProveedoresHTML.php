...
<head>
    <link rel="stylesheet" href="ProveedoresStyle2.css">
...
<body>
    ...
    <nav class="navbar-bottom">
        ...
        <button type="button" class="bottom-itemadd" onclick="window.location.href = 'FormProveedores.php';">
    ...
    <script src="ProveedoresJS.js"></script>
</body>
