...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if (isset($_POST['email']) && isset($_POST['password'])) {
        ...
        try {
            ...
            // Si se encontró un usuario administrador con las credenciales proporcionadas, proceder con la eliminación del usuario
            if ($adminUser) {
                // Construir la consulta SQL para eliminar el usuario
                $sql = "DELETE FROM dbo.Usuarios WHERE IDUsuario = :idUsuario";
                ...
                echo "Credenciales de administrador incorrectas. No tienes permiso para eliminar usuarios.";
            }
                        ...
                        <div class="row center">
                            <div class="col-md-6 text-center mx-auto">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="DeleteUser.php?id=<?php echo $idUsuario; ?>" method="post" id="login-form">
