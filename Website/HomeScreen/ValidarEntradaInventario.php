...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['email']) && isset($_POST['password'])) {
    ...
    try {
        ...
        $sql = "SELECT * FROM dbo.Usuarios WHERE eMail = :email AND Contraseña = :password";
        ...
        // Si las credenciales de usuario son válidas, redirigir al formulario de actualización
        if ($adminUser) {
            ...
            echo "Credenciales incorrectas. No tienes permiso para editar usuarios.";
        }
                ...
                <div class="row center">
                    <div class="col-md-6 text-center mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="ValidarEntradaInventario.php" method="post" id="login-form">
